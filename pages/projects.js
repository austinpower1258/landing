        ...
        <div className="p-6 sm:flex items-center shadow-md bg-black border border-color">
          <div className="md:px-10 sm:px-5">
            ...
            <div className="flex justify-between mb-2">
              ...
              <span className="sm:block hidden mb-2 text-gray-800 font-bold hover:underline"><Link href="https://drive.google.com/file/d/1F6ghUvvP9Tlr9KaD2RtLNrSfPzKvT-wv/view" className="hover:text-white">See demo</Link></span>
            </div>
          </div>
          <div className="p-6">
          ...
          <div className="shadow-md bg-black border">
            ...
            <div className="px-6">
              ...
              <div className="flex justify-between mt-4">
                ...
                <span className="mb-2 text-gray-800 font-bold py-4 hover:underline"><Link href="https://drive.google.com/file/d/1kcfOrbRpTyrIMW-bqjHdpqTd-j8py552/view?usp=sharing" className="hover:text-white">See demo</Link></span>
              </div>
            </div>
          </div>
          <div className="shadow-md bg-black border">
            ...
            <div className="px-6">
              ...
              <div className="flex justify-between mt-4">
                ...
                <span className="mb-2 text-gray-800 font-bold py-4 hover:underline"><Link href="https://drive.google.com/file/d/1rUMFNN1iRI7CWQ-eNDbM1VrAxjtTVxJ-/view?usp=sharing" className="hover:text-white">See demo</Link></span>
              </div>
            </div>
          </div>
        </div>
        <div className="sm:flex items-center bg-black border shadow-md mt-10">
          ...
          <div className="p-6 md:px-10 sh sm:px-5">
            ...
            <div className="flex justify-between mb-2">
              ...
              <span className="mb-2 py-4 text-gray-800 font-bold hover:underline"><Link href="https://twitter.com/austinywang/status/1424288644181893122?s=20" className="hover:text-white">See demo</Link></span>
            </div>
          </div>
        </div>
          ...
          <div className="shadow-md bg-black border">
            ...
            <div className="px-6">
              ...
              <div className="flex justify-between mt-4">
                ...
                <span className="mb-2 text-gray-800 font-bold py-4 hover:underline"><Link href="https://github.com/austinpower1258/sdv-cv" className="hover:text-white">See code</Link></span>
              </div>
            </div>
          </div>
          <div className="shadow-md bg-black border">
            ...
            <div className="px-6">
              ...
              <div className="flex justify-between mt-4">
                ...
                <span className="mb-2 text-gray-800 py-4 font-bold pp-2 hover:underline"><Link href="https://drive.google.com/file/d/1wbFlBgX4IxZLxqvwu9eekNs7PPOgDsj5/view" className="hover:text-white">See paper</Link></span>
              </div>
            </div>
          </div>
          <div className="shadow-md bg-black border">
            ...
            <div className="px-6">
              ...
              <div className="flex justify-between mt-6">
                ...
                <span className="mb-2 text-gray-800 font-bold py-4 pp-2 hover:underline"><Link href="https://drive.google.com/file/d/15f3L9kEIZQkX9NwVjkFTWEP6Oth1RRQ2/view?usp=sharing" className="hover:text-white">See paper</Link></span>
              </div>
            </div>
          </div>
        </div>
